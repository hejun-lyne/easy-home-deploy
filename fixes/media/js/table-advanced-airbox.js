var TableAdvanced = function () {
    ...
    var initTable1 = function() {
        ...
        function fnFormatDetails ( dTable, nTr )
        {
            ...
            sOut += '<tr><td>数据</td><td>'+aData[4]+'</td></tr>';
            sOut += '<tr><td>固件版本</td><td>'+aData[5]+'</td></tr>';
            sOut += '<tr><td>管理员</td><td>'+aData[6]+'</td></tr>';
            sOut += '<tr><td>连接用户</td><td>'+aData[7]+'</td></tr>';
            sOut += '<tr><td>连线时间</td><td>'+aData[8]+'</td></tr>';
            sOut += '</table>';
